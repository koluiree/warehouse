...
public record ProductDto(int Id, string Sku, string Name, string Unit, decimal MinQty, bool IsInteger, string? Description);
...
public record ProductRef(int Id, string Sku, string Name, string Unit, decimal MinQty, bool IsInteger);
...
public record IssueRequestDto(long Id, string RequesterId, string RequesterName, int DepartmentId, string Status, DateTime CreatedAt, DateTime? ApprovedAt, string? ApprovedById, string? Comment, List<IssueRequestItemSummary>? Items);
public record IssueRequestItemSummary(string ProductName, decimal RequestedQty, decimal IssuedQty);
...
public record StockMovementDto(long Id, int WarehouseId, string WarehouseName, int ProductId, string ProductSku, string ProductName, string Type, decimal Quantity, DateTime OccurredAt, string? DocumentNumber, string? Comment, string? PerformedById, string PerformedByName, long? RequestId);

public record AdminUserDto(string Id, string Username, string Email, bool IsActive, List<string> Roles, AdminUserDepartment? Department);
public record AdminUserDepartment(int Id, string Name);
